...
ENV JAVA_OPTS='-Xmx384m -Xmx384m -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=~/heapdump.hprof -Xloggc:~/gc.log' \
